...
// MARK: - Массив структур остановок
...
class APIKeyManager {
    ...
    let key = "https://api.mosgorpass.ru/v8.2/stop"
    
    private init() {}
}

// MARK: - Подробные данные по конкретной остановке
struct ExactStopResponse: Decodable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case lat, lon, cityShuttle, electrobus, transportTypes, routeName, shuttleType, regional, debug
    }
}

// MARK: - Данные по маршуруту
...
// MARK: - Хелперы для создания декодеров/энкодеров
